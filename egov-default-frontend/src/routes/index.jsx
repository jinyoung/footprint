...
import CodeList from 'pages/codeservice/CodeList';
import CodeDetail from 'pages/codeservice/CodeDetail';
import CodeEdit from 'pages/codeservice/CodeEdit';
import MetalOrderList from 'pages/metalorderservice/MetalOrderList';
import MetalOrderDetail from 'pages/metalorderservice/MetalOrderDetail';
import MetalOrderEdit from 'pages/metalorderservice/MetalOrderEdit';
import MoldList from 'pages/moldservice/MoldList';
import MoldDetail from 'pages/moldservice/MoldDetail';
import MoldEdit from 'pages/moldservice/MoldEdit';
...
const SecondRoutes = () => {
  ...
  return (
    <>
      <EgovHeader />
      <Routes>
          <Route path="/codeservice/codes" element={<CodeList />} />
          <Route path="/codeservice/CodeEdit" element={<CodeEdit />} />
          <Route path="/codeservice/CodeDetail" element={<CodeDetail />} />

          <Route path="/metalorderservice/metalOrders" element={<MetalOrderList />} />
          <Route path="/metalorderservice/MetalOrderEdit" element={<MetalOrderEdit />} />
          <Route path="/metalorderservice/MetalOrderDetail" element={<MetalOrderDetail />} />

          <Route path="/moldservice/molds" element={<MoldList />} />
          <Route path="/moldservice/MoldEdit" element={<MoldEdit />} />
          <Route path="/moldservice/MoldDetail" element={<MoldDetail />} />
