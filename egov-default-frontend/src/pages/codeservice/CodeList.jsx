        ...
        EgovNet.requestFetch(retrieveListURL,
            ...
            (resp) => {
                ...
                for(let i = 0; i< resp.length; i++){
                    ...
                    mutListTag.push(
                        <Link
                            to={{pathname: "/code/CodeDetail"}}
                            state={{
                                id: resp[i].id,
                                searchCondition: searchCondition}}                            
                            className="list_item">
                            <div>{i}</div>
                            <div>{resp[i].itemCode}</div>
                            <div>{resp[i].codeNo}</div>
                            <div>{resp[i].code}</div>
                            <div>{resp[i].codeName}</div>
                            <div>{resp[i].isSys}</div>
                            <div>{resp[i].isUse}</div>
                            <div>{resp[i].etc}</div>
                            <div>{resp[i].etc1}</div>
                            <div>{resp[i].etc2}</div>
                            <div>{resp[i].etc3}</div>
                ...
                <div className="layout">
                    ...
                    <div className="contents NOTICE_LIST" id="contents">
                        ...
                        <div className="top_tit">
                            <h1 className="tit_1">CodeService</h1>
                        </div>

                        <h2 className="tit_2">Code</h2>
                        ...
                        <div className="condition">
                            <ul>
                                ...
                                <li className="third_2 R">
                                    ...
                                    <li>
                                        <Link to="/codeService/CodeEdit" state={{bbsId: bbsId}} className="btn btn_blue_h46 pd35">등록</Link>
                                    </li>
                            </ul>
                        </div>
                        {/* <!--// 검색조건 --> */}
